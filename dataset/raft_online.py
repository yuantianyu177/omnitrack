...
from utils.utils import gen_grid_np
...
class SimpleDepthDataset(Dataset):
    def __init__(self, args, max_interval=None):
        ...
        self.inc_step = args.inc_step if args.inc_step > 0 else None
        self.img_range = mp.Value('i', self.inc_step) if self.inc_step > 0 else None
